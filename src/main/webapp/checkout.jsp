<%
   User user = (User) session.getAttribute("current-user");
    if (user == null) 
    {
        session.setAttribute("message", "you are not logged in !! Login first to access checkout page");   //if thhe value is not present in DB
            ...
            <div class="row mt-5">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card">
                        ...
                        <h3 class="text-center mb-3">Your details form order</h3>
